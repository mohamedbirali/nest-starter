...
import {
  IHelperGooglePayload, ///interfaces/helper.interface';
  HelperDateService, ///services/helper.date.service';
  HelperEncryptionService, ///services/helper.encryption.service';
  HelperGoogleService, ///services/helper.google.service';
  HelperHashService, ///services/helper.hash.service';
  HelperStringService,
} from '@bee/common/helper'; ///services/helper.string.service';
...
export class AuthService implements IAuthService {
  ...
  async payloadAccessToken(
    ...
    return this.helperEncryptionService.jwtDecrypt(token) as any;
  }
