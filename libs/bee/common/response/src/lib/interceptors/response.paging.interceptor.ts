...
import { MessageService } from '@bee/common/message'; ///services/message.service';
...
import { IMessage, IMessageOptionsProperties } from '@bee/common/message'; ///interfaces/message.interface';
import {
